(function () {
  ...
  var ConnectableObservable = (function (  super  ) {

    function subscribe(observer) {
      return this. o.subscribe(observer);
    }

    inherits(ConnectableObservable,   super  );

    function ConnectableObservable(o, s) {
        super  .call(this, subscribe);
  ...
  var MySubject = (function (  super  ) {
    inherits(MySubject,   super  );
