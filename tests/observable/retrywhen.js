...
// test('RetryWhen_Observable_Error', function () {
...
// test('RetryWhen_Observable_Throws', function () {
...
// test('RetryWhen_Observable_RetryCount_Basic', function () {
//     var ex, results, scheduler, xs;
//     scheduler = new TestScheduler();
//     ex = 'ex';
...
// test('RetryWhen_Observable_RetryCount_Dispose', function () {
//     var ex, results, scheduler, xs;
//     scheduler = new TestScheduler();
//     ex = 'ex';
//     xs = scheduler.createColdObservable(onNext(5, 1), onNext(10, 2), onNext(15, 3), onError(20, ex));
...
// test('RetryWhen_Observable_RetryCount_Throws', function () {
//     var d, scheduler1, scheduler2, scheduler3, xs, xss, ys, zs;
//     scheduler1 = new TestScheduler();
