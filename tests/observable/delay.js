...
(function () {
  ...
  test('delay duration simple 2', function () {
    ...
    var ys = scheduler.createColdObservable(onNext(10, '!'));
  ...
  test('delay duration simple 3', function () {
    ...
    var ys = scheduler.createColdObservable(onNext(100, '!'));
  ...
  test('delay duration simple 4 inner empty', function () {
    ...
    var ys = scheduler.createColdObservable(onCompleted(100));
    var results = scheduler.startWithCreate(function () {
      return xs.delayWithSelector(function () {
        return ys;
      });
  ...
  test('delay duration dispose 1', function () {
    ...
    var ys = scheduler.createColdObservable(onNext(200, '!'));
  ...
  test('delay duration dispose 2', function () {
    ...
    var ys = scheduler.createColdObservable(onNext(50, '!'));
