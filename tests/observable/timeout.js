...
test('Timeout_TimeoutOccurs_1', function () {
  ...
  var scheduler = new TestScheduler();
  var xs = scheduler.createHotObservable(onNext(70, 1), onNext(130, 2), onNext(310, 3), onNext(400, 4), onCompleted(500));
...
test('Timeout_TimeoutOccurs_2', function () {
  ...
  var scheduler = new TestScheduler();
  var xs = scheduler.createHotObservable(onNext(70, 1), onNext(130, 2), onNext(240, 3), onNext(310, 4), onNext(430, 5), onCompleted(500));
  ys = scheduler.createColdObservable(onNext(50, -1), onNext(200, -2), onNext(310, -3), onCompleted(320));
  var results = scheduler.startWithCreate(function () {
      return xs.timeout(100, ys, scheduler);
  });
...
test('Timeout_TimeoutOccurs_Error', function () {
  ...
  var scheduler = new TestScheduler();
  var xs = scheduler.createHotObservable(onError(500, 'ex'));
  ys = scheduler.createColdObservable(onNext(100, -1));
  var results = scheduler.startWithCreate(function () {
      return xs.timeout(100, ys, scheduler);
  });
...
test('Timeout_TimeoutNotOccurs_Completed', function () {
  ...
  var scheduler = new TestScheduler();
  var xs = scheduler.createHotObservable(onCompleted(250));
  ys = scheduler.createColdObservable(onNext(100, -1));
  var results = scheduler.startWithCreate(function () {
      return xs.timeout(100, ys, scheduler);
  });
...
test('Timeout_TimeoutNotOccurs_Error', function () {
  ...
  ex = 'ex';
  var scheduler = new TestScheduler();
  var xs = scheduler.createHotObservable(onError(250, ex));
  ys = scheduler.createColdObservable(onNext(100, -1));
  var results = scheduler.startWithCreate(function () {
      return xs.timeout(100, ys, scheduler);
  });
...
test('Timeout_TimeoutDoesNotOccur', function () {
  ...
  var scheduler = new TestScheduler();
  var xs = scheduler.createHotObservable(onNext(70, 1), onNext(130, 2), onNext(240, 3), onNext(320, 4), onNext(410, 5), onCompleted(500));
  ys = scheduler.createColdObservable(onNext(50, -1), onNext(200, -2), onNext(310, -3), onCompleted(320));
  var results = scheduler.startWithCreate(function () {
      return xs.timeout(100, ys, scheduler);
  });
...
test('Timeout_DateTimeOffset_TimeoutOccurs', function () {
  ...
  var scheduler = new TestScheduler();
  var xs = scheduler.createHotObservable(onNext(410, 1));
  ys = scheduler.createColdObservable(onNext(100, -1));
  var results = scheduler.startWithCreate(function () {
...
test('Timeout_DateTimeOffset_TimeoutDoesNotOccur_Completed', function () {
  ...
  var scheduler = new TestScheduler();
  var xs = scheduler.createHotObservable(onNext(310, 1), onCompleted(390));
  ys = scheduler.createColdObservable(onNext(100, -1));
  var results = scheduler.startWithCreate(function () {
      return xs.timeout(new Date(400), ys, scheduler);
  });
...
test('Timeout_DateTimeOffset_TimeoutDoesNotOccur_Error', function () {
  ...
  ex = 'ex';
  var scheduler = new TestScheduler();
  var xs = scheduler.createHotObservable(onNext(310, 1), onError(390, ex));
  ys = scheduler.createColdObservable(onNext(100, -1));
  var results = scheduler.startWithCreate(function () {
      return xs.timeout(new Date(400), ys, scheduler);
  });
...
test('Timeout_DateTimeOffset_TimeoutOccur_2', function () {
  ...
  var scheduler = new TestScheduler();
  var xs = scheduler.createHotObservable(onNext(310, 1), onNext(350, 2), onNext(420, 3), onCompleted(450));
  ys = scheduler.createColdObservable(onNext(100, -1));
  var results = scheduler.startWithCreate(function () {
      return xs.timeout(new Date(400), ys, scheduler);
  });
