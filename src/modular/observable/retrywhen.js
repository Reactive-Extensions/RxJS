...
CatchErrorWhenObservable.prototype.subscribeCore = function (o) {
  ...
  var cancelable = global._Rx.currentThreadScheduler.scheduleRecursive(null, function (_, self) {
    if (state.isDisposed) { return; }
    var currentItem = tryCatch(e.next).call(e);
    if (currentItem === global._Rx.errorObj) { return o.onError(currentItem.e); }
