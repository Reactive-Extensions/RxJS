...
(function() {
    ...
    o.sample(100);
    o.sample(100, Rx.Scheduler.timeout);
    o.sample(Rx.Observable.interval(100));
    o.sample(Rx.Observable.interval(100), Rx.Scheduler.timeout);

    o.throttleLatest(100);
    o.throttleLatest(100, Rx.Scheduler.timeout);
    o.throttleLatest(Rx.Observable.interval(100));
    o.throttleLatest(Rx.Observable.interval(100), Rx.Scheduler.timeout);
});
